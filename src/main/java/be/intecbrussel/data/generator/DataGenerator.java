...
public class DataGenerator {
    ...
    public CommandLineRunner loadData(PasswordEncoder passwordEncoder, UserRepository userRepository,
        ...
        return args -> {
            ...
            ExampleDataGenerator<Upload> uploadRepositoryGenerator = new ExampleDataGenerator<>(Upload.class,
            ...
            uploadRepositoryGenerator.setData(Upload::setContent, DataType.FOOD_PRODUCT_IMAGE);
            ...
            ExampleDataGenerator<Download> downloadRepositoryGenerator = new ExampleDataGenerator<>(Download.class,
                    LocalDateTime.of(2022, 6, 14, 0, 0, 0));
